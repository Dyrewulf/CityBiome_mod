...
import dyrewulf.citybiome.genlayer.DyreCityGenLayer;

public class WorldChunkManagerDyreCity extends WorldChunkManager {
	...
	public WorldChunkManagerDyreCity()
	{
	...
	public WorldChunkManagerDyreCity(long seed, WorldType worldType)
	{
		this();
		// i changed this to my GenLayerTutorial
		GenLayer[] agenlayer = DyreCityGenLayer.makeTheWorld(seed, worldType);
		agenlayer = getModdedBiomeGenerators(worldType, seed, agenlayer);
		this.genBiomes = agenlayer[0];
		this.biomeIndexLayer = agenlayer[1];
	}

	public WorldChunkManagerDyreCity(World world)
	{
