...
import dyrewulf.citybiome.world.renderer.CloudRenderer;
import dyrewulf.citybiome.world.renderer.SkyRenderer;
import dyrewulf.citybiome.world.renderer.WeatherRenderer;


public class WorldProviderDyreCity extends WorldProvider{
	
	@Override
	/** tells Minecraft to use our new Terrain Generator */
	public IChunkProvider createChunkGenerator() {
		return new ChunkProviderDyreCity(this.worldObj, this.worldObj.getSeed(), false);
	}

	@Override
	/** tells Minecraft to use our new WorldChunkManager **/
	public void registerWorldChunkManager() {
		this.worldChunkMgr = new WorldChunkManagerDyreCity(worldObj.getSeed(), terrainType);
		this.dimensionId = Reference.DIMID;
	}
