...
public class WorldGenCityMinable extends WorldGenerator
{
	/** Block to replace */
	 ...
	 */
	public WorldGenCityMinable(Block blockToPlace, int howMeny, Block replaceableBlock)
	{
	 ...
	 * @param target
	 */
	public WorldGenCityMinable(Block block, int meta, int number, Block target)
	{
