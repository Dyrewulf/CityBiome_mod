package dyrewulf.citybiome.world.gen;
...
public class WorldGenCityTrees extends WorldGenCityAbstractTree
{
	    ...
	    public WorldGenCityTrees(boolean p_i2027_1_)
	    {
	        this(p_i2027_1_, 6, leaves, wood, false);
	    }

	    public WorldGenCityTrees(boolean p_i2028_1_, int minTreeHeight, Block metaWood, Block metaLeaves, boolean growVines)
	    {
	        super(p_i2028_1_);
	        this.minTreeHeight = minTreeHeight;
	        WorldGenCityTrees.wood = metaWood;
	        WorldGenCityTrees.leaves = metaLeaves;
